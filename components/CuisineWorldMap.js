...
const GROUP_COLORS = {
  ...
  lithuanian: '#7A8F3D',
  belgian: '#3D3D8F',
  luxembourgish: '#5C8FA0',
  fijian: '#3D8FA8',
  'new-caledonian': '#8FA83D',
  'solomon-islander': '#A8663D',
  'ni-vanuatu': '#3DA85C',
  bahamian: '#3D8FA0',
  taiwanese: '#A83D6B',
  'north-korean': '#5C3D8F',
  ...
  armenian: '#D4823D',
  azerbaijani: '#3D6B99',
  // Africa is also a regional drill-down cluster on the world map (using
  // the africa color above there), but each country needs its own real
  // color for the zoomed regional view.
  algerian: '#D82626',
  angolan: '#A63C30',
  beninese: '#C55639',
  botswanan: '#B64F20',
  ...
  'cape-verdean': '#B69F2E',
  cameroonian: '#A5A62E',
  'central-african-republic': '#87A63C',
  chadian: '#5FA633',
  comorian: '#3DA637',
  'congo-brazzaville': '#33A652',
  ivorian: '#2EA672',
  congolese: '#2EA695',
  djiboutian: '#2E96A6',
  egyptian: '#2E76A6',
  'equatorial-guinean': '#2E56A6',
  eritrean: '#3737A6',
  swazi: '#5F2EA6',
  ethiopian: '#832EA6',
  gabonese: '#A62E9C',
  ...
  reunionese: '#D86426',
  rwandan: '#D84326',
  'saint-helenian': '#C53939',
  'sao-tomean': '#A63C5B',
  senegalese: '#A63C85',
  seychellois: '#8A3CA6',
  'sierra-leonean': '#623CA6',
  somali: '#3C4EA6',
  'south-sudanese': '#3C76A6',
  sudanese: '#3C9EA6',
  tanzanian: '#3CA67A',
  togolese: '#3CA652',
  tunisian: '#5CA63C',
